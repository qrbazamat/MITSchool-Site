...
export const AppsIcons = [
    new CreateIcon(IconPuzzle_9, 'Puzzle 9'),
    new CreateIcon(IconClockDigital, 'Digital clock'),
    new CreateIcon(IconClock, 'Clock'),
    new CreateIcon(IconCurrency_1, 'Currency 1'),
    new CreateIcon(IconCurrency_2, 'Currency 2'),
    new CreateIcon(IconCalcCircle, 'Calculator'),
    new CreateIcon(IconCurrency_3, 'Currency 3'),
    new CreateIcon(IconPuzzle_9_r, 'Puzzle 9'),
    new CreateIcon(IconCalcSquare, 'Calculator apps'),
    new CreateIcon(IconPuzzle_16, 'Puzzle 16'),
    new CreateIcon(IconTemperatureConverter, 'Converter'),
    new CreateIcon(IconTicTacToeCircle, 'Tic Tac Toe'),
    new CreateIcon(IconTicTacToeSquare, 'Tic Tac Toe'),
    new CreateIcon(IconTicTacToeTransparent, 'Tic Tac Toe'),
    new CreateIcon(IconTodo_1, 'Todo 1'),
    new CreateIcon(IconTodo_2, 'Todo 2'),
    new CreateIcon(IconTodo_3, 'Todo 3'),
    new CreateIcon(IconTodo_4, 'Todo 4'),
    new CreateIcon(IconCalcCircle, 'Calculator'),
    new CreateIcon(IconCalcSquare, 'Calculator apps'),
    new CreateIcon(IconClockDigital, 'Digital clock'),
    new CreateIcon(IconClock, 'Clock'),
